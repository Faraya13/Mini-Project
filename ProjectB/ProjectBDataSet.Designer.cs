...
namespace ProjectB {
    ...
    public partial class ProjectBDataSet : global::System.Data.DataSet {
        ...
        public partial class RubricDataTable : global::System.Data.TypedTableBase<RubricRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public RubricRow AddRubricRow(string Details, CloRow parentCloRowByFK_Rubric_Clo) {
...
SELECT Id, Name, DateCreated, DateUpdated FROM Clo WHERE (Id = @Id)";
    ...
    public partial class RubricTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.InsertCommand.Connection = this.Connection;
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Rubric] ([Details], [CloId]) VALUES (@Details, @CloId);\r\nSELEC" +
                "T Id, Details, CloId FROM Rubric WHERE (Id = SCOPE_IDENTITY())";
            this._adapter.InsertCommand.CommandType = global::System.Data.CommandType.Text;
            ...
            this._adapter.UpdateCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.UpdateCommand.Connection = this.Connection;
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Rubric] SET [Details] = @Details, [CloId] = @CloId WHERE (([Id] = @" +
                "Original_Id) AND ([CloId] = @Original_CloId));\r\nSELECT Id, Details, CloId FROM R" +
                "ubric WHERE (Id = @Id)";
            this._adapter.UpdateCommand.CommandType = global::System.Data.CommandType.Text;
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Insert, true)]
        public virtual int Insert(string Details, int CloId) {
            if ((Details == null)) {
            ...
            this.Adapter.InsertCommand.Parameters[1].Value = ((int)(CloId));
            global::System.Data.ConnectionState previousConnectionState = this.Adapter.InsertCommand.Connection.State;
            if (((this.Adapter.InsertCommand.Connection.State & global::System.Data.ConnectionState.Open) 
                        != global::System.Data.ConnectionState.Open)) {
                this.Adapter.InsertCommand.Connection.Open();
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Details, int CloId, int Original_Id, int Original_CloId, int Id) {
            if ((Details == null)) {
                throw new global::System.ArgumentNullException("Details");
            }
            else {
            ...
            this.Adapter.UpdateCommand.Parameters[1].Value = ((int)(CloId));
            this.Adapter.UpdateCommand.Parameters[2].Value = ((int)(Original_Id));
            this.Adapter.UpdateCommand.Parameters[3].Value = ((int)(Original_CloId));
        ...
        public virtual int Update(string Details, int CloId, int Original_Id, int Original_CloId) {
            return this.Update(Details, CloId, Original_Id, Original_CloId, Original_Id);
        }
    }
